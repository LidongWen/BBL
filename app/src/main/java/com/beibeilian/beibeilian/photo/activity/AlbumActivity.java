...
import com.beibeilian.beibeilian.photo.adapter.AlbumGridViewAdapter;
import com.beibeilian.beibeilian.photo.util.AlbumHelper;
import com.beibeilian.beibeilian.photo.util.Bimp;
import com.beibeilian.beibeilian.photo.util.ImageBucket;
...
public class AlbumActivity extends Activity {
	...
	private class AlbumSendListener implements OnClickListener {
		public void onClick(View v) {
			...
			intent.setClass(mContext, QAAddActivity.class);
			startActivity(intent);
			finish();
		}

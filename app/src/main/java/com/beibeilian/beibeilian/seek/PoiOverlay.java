...
public class PoiOverlay {
	 ...
	 *            地图对象。
	 * @param pois
	 *            要在地图上添加的poi。列表中的poi对象详见搜索服务模块的基础核心包（com.amap.api.services.core
	 *            ）中的类<strong> <a href=
	 *            "../../../../../../Search/com/amap/api/services/core/PoiItem.html"
	...
	public void zoomToSpan() {
		try {
			if (mPois != null && mPois.size() > 0) {
				...
				if (mPois.size() == 1) {
					mAMap.moveCamera(
							CameraUpdateFactory.newLatLngZoom(new LatLng(mPois.get(0).getLatLonPoint().getLatitude(),

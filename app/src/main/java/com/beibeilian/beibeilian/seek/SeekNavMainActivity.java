...
public class SeekNavMainActivity extends Activity implements LocationSource, AMapLocationListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mSweetAlertDialog = new SweetAlertDialog(SeekNavMainActivity.this);
		...
		btnNav.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent mIntent = new Intent(SeekNavMainActivity.this, GPSNaviActivity.class);
		...
		tv_eloaction.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				startActivity(new Intent(SeekNavMainActivity.this, SeekPoiKeywordSearchActivity.class));
			}
		});

 ...
 */
public class SeekPoiKeywordSearchActivity extends Activity implements LocationSource, AMapLocationListener,AMap.OnMarkerClickListener, AMap.InfoWindowAdapter, TextWatcher,
		PoiSearch.OnPoiSearchListener, OnClickListener, Inputtips.InputtipsListener {
	private AMap aMap;
	private AutoCompleteTextView searchText;// 输入搜索关键字
	private String keyWord = "",address;// 要输入的poi搜索关键字
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		init();
		Button btnconfirm=(Button)findViewById(R.id.btn_confirm_id);
		btnconfirm.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(lat<=0)
				{
					HelperUtil.totastShow("请选择终点坐标",getApplicationContext());
					return;
				}
				Intent mIntent=new Intent(ReceiverConstant.LOCATION_MESSAGE_ACTION);
	...
	public void searchButton() {
		...
		if ("".equals(keyWord)) {
			ToastUtil.show(SeekPoiKeywordSearchActivity.this, "请输入搜索关键字");
			return;
		} else {
			doSearchQuery();
		}
	...
	public void nextButton() {
		if (query != null && poiSearch != null && poiResult != null) {
			if (poiResult.getPageCount() - 1 > currentPage) {
				...
				ToastUtil.show(SeekPoiKeywordSearchActivity.this, R.string.no_result);
			}
		}
	}
	...
	private void showSuggestCity(List<SuggestionCity> cities) {
		...
		ToastUtil.show(SeekPoiKeywordSearchActivity.this, infomation);
	...
	public void onTextChanged(CharSequence s, int start, int before, int count) {
		...
		if (!AMapUtil.IsEmptyOrNullString(newText)) {
			...
			Inputtips inputTips = new Inputtips(SeekPoiKeywordSearchActivity.this, inputquery);
	...
	public void onGetInputtips(List<Tip> tipList, int rCode) {
		if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
			...
			ArrayAdapter<String> aAdapter = new ArrayAdapter<String>(getApplicationContext(), R.layout.route_inputs,
					listString);
...
//			mLocationOption.setInterval(5000);
	...
	private int recordLoaction=0;
	@Override
	public void onLocationChanged(AMapLocation location) {
		// TODO Auto-generated method stub
		if(mListener != null&&location != null&&recordLoaction==0)
		{
			if (location != null

...
import com.beibeilian.beibeilian.circle.spannable.CircleMovementMethod;
import com.beibeilian.beibeilian.circle.spannable.NameClickListener;
import com.beibeilian.beibeilian.circle.spannable.NameClickable;
...
public class CommentAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		// SpannableString contentSpanText = new
		// SpannableString(contentBodyStr);
		// contentSpanText.setSpan(new UnderlineSpan(), 0,
		// contentSpanText.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);

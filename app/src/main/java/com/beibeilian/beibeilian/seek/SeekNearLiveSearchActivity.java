 ...
 */
public class SeekNearLiveSearchActivity extends Activity implements LocationSource, AMapLocationListener,AMap.OnMarkerClickListener, AMap.InfoWindowAdapter, TextWatcher,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.seek_nearlive_search_activity);
	...
	public void searchButton() {
		...
		if ("".equals(keyWord)) {
			ToastUtil.show(SeekNearLiveSearchActivity.this, "请输入搜索关键字");
			return;
		} else {
			doSearchQuery();
		}
	...
	public void nextButton() {
		if (query != null && poiSearch != null && poiResult != null) {
			if (poiResult.getPageCount() - 1 > currentPage) {
				...
				ToastUtil.show(SeekNearLiveSearchActivity.this, R.string.no_result);
			}
		}
	}
	...
	private void showSuggestCity(List<SuggestionCity> cities) {
		...
		ToastUtil.show(SeekNearLiveSearchActivity.this, infomation);
	...
	public void onTextChanged(CharSequence s, int start, int before, int count) {
		...
		if (!AMapUtil.IsEmptyOrNullString(newText)) {
			...
			Inputtips inputTips = new Inputtips(SeekNearLiveSearchActivity.this, inputquery);
